...
{ content = "Ommpa Loompa Dompaty Doo (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
{ content = "blahblahblahblah (created via our dynamic block)", file = "/terraform/test2.txt", executable = true },
]
